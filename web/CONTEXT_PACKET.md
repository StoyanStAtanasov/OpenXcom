...
Generated: 2026-05-25T15:21:16.182Z
Role: resume
...
- Local Codex status: gpt-5.5 (xhigh); context 33.1% left (172871/258400 latest input tokens); credits not reported locally
...
- Slice percent: 99.95%
- Next action: Continue tactical battle runtime restoration beyond the verified saved-battle/path/line/spotting/casualty/hit/projectile-drop/shotgun/reaction-cleanup baseline: next source-backed target is ExplosionBState audio/cosmetic camera polish and any remaining complete projectile handoff edges.
...
| --- | --- | --- | ---: | --- |
| Original save conversion folder ingestion data | Savegame | partial-integrated-verified | 99.95% | Continue tactical battle runtime restoration beyond the verified saved-battle/path/line/spotting/casualty/hit/projectile-drop/shotgun/reaction-cleanup baseline: next source-backed target is ExplosionBState audio/cosmetic camera polish and any remaining complete projectile handoff edges. |
...
```text
Read-only sidecar for OpenXcom TS port slice "Original save conversion folder ingestion data" (99.95%).
Do not edit files.
