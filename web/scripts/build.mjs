...
await writeFile(join(dist, "resource-manifest.json"), JSON.stringify({
  ...
  ufoIntroFiles: await findOriginalFiles(ufoRoots, "UFOINTRO"),
  ...
  tftdAnimsFiles: await findOriginalFiles(tftdRoots, "ANIMS"),
  tftdFlopIntFiles: await findOriginalFiles(tftdRoots, "FLOP_INT"),
