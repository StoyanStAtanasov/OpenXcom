...
export class Options {
  ...
  static geoscapeScale = SCALE_ORIGINAL;
  static battlescapeScale = SCALE_ORIGINAL;
  static newGeoscapeScale = SCALE_ORIGINAL;
  static newBattlescapeScale = SCALE_ORIGINAL;
  static baseXGeoscape = 320;
  static baseYGeoscape = 200;
  static baseXBattlescape = 320;
  static baseYBattlescape = 200;
  static language = "";
  static assetBase = "..";
  ...
  static resetDefault(includeMods = false): void {
    ...
    Options.baseXGeoscape = 320;
    Options.baseYGeoscape = 200;
    Options.baseXBattlescape = 320;
    Options.baseYBattlescape = 200;
